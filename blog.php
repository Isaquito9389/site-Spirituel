            ...
            <div class="lg:w-3/4 lg:pr-8">
                ...
                <?php else: ?>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <a href="blog-post.php?id=<?php echo $post['id']; ?>" class="card rounded-lg overflow-hidden shadow-lg hover:shadow-xl">
            ...
            <div class="lg:w-1/4 mt-8 lg:mt-0">
                ...
                <div class="card p-6 rounded-lg shadow-lg mb-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <a href="blog-post.php?id=<?php echo $post['id']; ?>" class="flex items-center group">
                            <?php if (!empty($post['featured_image'])): ?>
